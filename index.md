...
<section id="hero" class="hero bg-navy">
    <div class="container hero-inner">
        <div class="hero-content">
            ...
            <span class="badge reveal-element">👋 مرحباً بك!</span>
            <!-- ✏️ EDIT: العنوان الرئيسي — اسمك + لقبك -->
            <h1 class="hero-title reveal-element">أنا خالد<br><span class="highlight">طالب اتصال تسويقي</span></h1>
            <!-- ✏️ EDIT: الوصف المختصر تحت العنوان -->
            <p class="hero-desc reveal-element">أحوّل البيانات إلى استراتيجيات تسويقية تُحقق نتائج. أؤمن بأن كل تـصـرف أذكـى يبدأ بـتفكيـر أعمق. مهتم بالتخطيط الاستراتيجي وبناء العلامات التجارية.</p>
        ...
        <div class="hero-image-wrapper reveal-element">
            <div class="profile-image-container">
                <img src="{{ '/assets/images/profile.webp' | relative_url }}" alt="خالد وليد هاشم" class="profile-image">
            </div>
        </div>
    </div>
    <!-- ══════════════════════════════════════════════════════════════════
    ...
    <div class="container hero-footer-container">
        ...
        <div class="skills-floating-group reveal-element">
            <div class="skill-tag">
                <i class="fa-solid fa-magnifying-glass-chart"></i> تحليل السوق
            </div>
            <div class="skill-tag">
                <i class="fa-solid fa-brain"></i> سلوك المستهلك
            </div>
            <div class="skill-tag">
                <i class="fa-solid fa-map-location-dot"></i> تحسين محركات البحث SEO
            </div>
            <div class="skill-tag">
                <i class="fa-solid fa-compass"></i> التخطيط التسويقي
            </div>
        </div>
        -->
...
<section id="portfolio" class="portfolio bg-light">
    <div class="container">
        <div class="section-header">
            ...
            {% assign ar_all_works = site.case_studies | where: "lang", "ar" %}
            {% assign ar_all_projects = site.projects | where: "lang", "ar" %}
            {% assign ar_total = ar_all_works.size | plus: ar_all_projects.size %}
        ...
        <div class="portfolio-grid">
            {%- comment -%}
              ── أبرز أعمالي: آخر 2 عمل منشور ──
              Filter: status=published AND lang=ar
              Sort by: date descending → take first 2
            {%- endcomment -%}
            {%- assign market_cs_home = site.case_studies | where: "lang", "ar" | where: "publish_state", "published" | sort: "date" | reverse -%}
            {%- assign market_pr_home = site.projects     | where: "lang", "ar" | where: "publish_state", "published" | sort: "date" | reverse -%}
            ...
            <div class="cv-column">
                ...
                <div class="timeline">
                    ...
                    <div class="timeline-item">
                        <div class="timeline-dot"></div>
                        <!-- ✏️ EDIT: الفترة الزمنية -->
                        <div class="timeline-date">يناير 2026 - الآن</div>
                        <!-- ✏️ EDIT: المسمى الوظيفي -->
