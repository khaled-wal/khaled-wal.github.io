...
permalink: /en/portfolio/case-studies/shawarma-house-case/
publish_state: "published"          # ⚠️ Review publish state before deployment

study_type: "analysis"
type_label: "In-Depth Marketing Analysis"

title: "Bayt Al Shawarma: When Growth Swallows the Name Built Upon It"
subtitle: "Brand Positioning Case Study — From Absolute Specialization to an All-Inclusive Food Platform"
...
brand_analyzed: "Bayt Al Shawarma"
key_takeaway: "Horizontal menu expansion is funded by the vertical specialization equity upon which the brand was originally built—and that equity is not bottomless."
core_critique: "The name \"Bayt Al Shawarma\" establishes an implicit promise of absolute specialization. However, expanding to over 600 items has generated a clear disconnect between this promise and the experience of the signature brand-named product—a gap measured not by price-to-value ratio, but by cognitive consistency between brand name and product."
founded: 2000
market_position: "Typically ranked 4th among 5 major competing brands in the classic shawarma category in Riyadh"

# ═══ General Taxonomy ═══
sector: "Food & Beverage (F&B) / Restaurants"
date: 2026-07-18               # ⚠️ Adjust actual publication date
order: 1
tags:
  - "Brand Positioning"
  - "Restaurant Industry"
...
editorial_disclaimer: "This is an independent, non-funded analysis that is in no way affiliated with or endorsed by the Bayt Al Shawarma brand. It is based on market observation and publicly available general analysis of menu offerings and competitive positioning. All opinions expressed are purely analytical and reflect the author's personal views."

# ═══ Opening Hook Quote & Closing Question ═══
#hook_quote: "Over a family dinner, a simple question was raised: 'If you were alone, would you order from Bayt Al Shawarma?'"
#closing_question: "At what point does diversification transform from a pillar that expands brand equity into a force of substitution that swallows its core positioning from within?"

# ═══ Sidebar Table of Contents ═══
toc_items:
  - id: "section-1"
    label: "Structural Shift in Positioning"
  - id: "section-2"
    label: "The Quality Paradox"
  - id: "section-3"
    label: "The Brand Promise Gap"
  - id: "section-4"
    label: "Root Cause of Operational Challenges"
  - id: "section-5"
    label: "The Short-Term Marketing Trap"
  - id: "section-6"
    label: "Strategic Blind Spots"
  - id: "section-7"
    label: "Strategic Directions for Remediation"
  - id: "conclusion"
    label: "Conclusion"
---
...
<h2 id="section-1">1. Structural Shift in Positioning — From Hero Product to Collective Decision Resolver</h2>
...
<h2 id="section-2">2. The Quality Paradox — When the Margin Outperforms the Core</h2>
...
<h2 id="section-3">3. The Brand Promise Gap — When the Name Fails Itself</h2>
...
<h2 id="section-4">4. Root Cause of Operational Challenges</h2>
...
<h2 id="section-5">5. The Short-Term Marketing Trap</h2>
...
<h2 id="section-6">6. Strategic Blind Spots — Long-Term Existential Risks</h2>
...
<h2 id="section-7">7. Strategic Directions for Remediation</h2>
...
<h2 id="conclusion">Conclusion: A Success Story with a Deferred Bill</h2>
