...
<section class="portfolio-page-section bg-light">
  <div class="container">
    ...
    ══════════════════════════════════════════════════════════════ -->
    <div class="portfolio-tier-market reveal-element">
    ...
    {% if all_lab.size > 0 %}
    <div class="portfolio-tier-lab reveal-element">
      <span class="tier-label">
        <i class="fa-solid fa-flask" aria-hidden="true"></i>
        مختبر الأعمال · مساحة استكشافية
      </span>
      <div class="portfolio-grid-custom tier-lab-blueprint">
        ...
        <article class="portfolio-card">
            <div class="card-image">
                ...
                {% else %}
                <div class="card-placeholder">
                  <i class="fa-solid fa-flask fa-3x" aria-hidden="true"></i>
                </div>
                {% endif %}
            </div>
            <div class="card-content">
    ...
    <div class="portfolio-tier-coming-soon reveal-element">
      <span class="tier-label">
        ...
        <div class="coming-soon-card" aria-label="{{ item.title }} — قيد التنفيذ" role="article">
          <article class="portfolio-card">
              <div class="card-image">
                  ...
                  {% else %}
                  <div class="card-placeholder">
                    <i class="fa-solid fa-hourglass-half fa-3x" aria-hidden="true"></i>
                  </div>
                  {% endif %}
              </div>
              <div class="card-content">
